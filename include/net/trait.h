...
int traits_init(void *traits, void *hard_end)
{
    // TODO - this is awkward, and will never be needed in practice.
    // If a driver supports metadata, the headroom should be greater than two bytes.
    // Or can we make xdp handle it semi gracefully?
